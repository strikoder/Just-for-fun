...
class BiLSTM(nn.Module):
    ...
    def forward(self,x):
        h0=torch.zeros(self.num_layers*2,x.size(0,self.hidden_size)).to(device) #*2 bidirecational
        c0=torch.zeros(self.num_layers*2,x.size(0,self.hidden_size)).to(device) #*2 bidirecational
